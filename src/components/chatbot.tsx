...
export default function Chatbot() {
	...
	return (
		<div className="w-full h-screen flex items-center justify-center px-2 bg-gray-100">
			<div className="flex flex-col w-full max-w-lg h-[90vh] bg-white rounded-xl shadow-lg overflow-hidden">
				{/* Header */}
				<div className="text-lg font-semibold text-center text-blue-600 py-4 border-b border-gray-200 bg-white">
					🤖 Chatbot
				</div>
